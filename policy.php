...
<body style="background-color:black">
    ...
    renderHeader();
    ?>
    <div style="display:flex;justify-content:center;align-items:center;flex-direction:column;text-align:justify;margin:0px 30px;">
...
This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name bizvizcards.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').

The Platform is owned by BLUE TICKS INNOVATIONS PRIVATE LIMITED, a company incorporated under the Companies Act, 1956 with its registered office at Thataguni, Bangalore South, Bangalore Rural- 560082, Karnataka ,Bangalore ,India (hereinafter referred to as ?Platform Owner?, 'we', 'us', 'our')..
...
BLUE TICKS INNOVATIONS PRIVATE LIMITED does not accept cancellation requests 
...
In case of any refunds approved by BLUE TICKS INNOVATIONS PRIVATE LIMITED, it will take 5 days for the refund to be processed to you.
