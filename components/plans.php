...
<section class="plans__container" style="background-color:white">
  <div class="plans">
    <div class="plansHero">
    ...
    <div class="planItem__container">
      <!--free plan starts -->
      <div class="planItem planItem--free" style="background-color:#e5eaf5">
        ...
        <div class="price">499 Rs.<span>/ Year</span></div>

        <ul class="featureList">
          <li>1 User Profile.</li>
          <li>Unlimited Updates</li>
          <li class="disabled">Premium BizViz Card</li>
        </ul>
      ...
      <!--pro plan starts -->
      <div class="planItem planItem--pro" style="background-color:#2d545e">
        <div class="card">
          <div class="card__header">
            <div ></div>
            <h2>Individual</h2>
        ...
        <div class="price">999 Rs. <span>/ Year</span></div>

        <ul class="featureList">
          <li>1 User Profile.</li>
          <li>Unlimited Updates</li>
          <li class="">Premium BizViz Card</li>
        </ul>
      ...
      <!--entp plan starts -->
      <div class="planItem planItem--entp" style="background-color:black"">
        <div class="card">
          <div class="card__header">
            <div ></div>
        ...
        <div class="price">Lets Talk</div>

        <ul class="featureList">
          <li>Unlimited User Profiles</li>
          <li>Unlimited Updates</li>
          <li>Premium BizViz Card for Each Profile Created</li>
          <li>Admin Access</li>
          <li>Reprogrammable BizViz Card</li>
        </ul>
